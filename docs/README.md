...
| [mac-system-audio-plan.md](mac-system-audio-plan.md) | Phased Mac system-audio plan (not shipped) |
| [providers.md](providers.md)                         | STT and LLM provider registry              |
| [security.md](security.md)                           | Secrets, OAuth, consent                    |
| [oauth-clients.md](oauth-clients.md)                 | Google Cloud and Microsoft Entra clients   |
| [coding-guidelines.md](coding-guidelines.md)         | Vue/TS style, KISS/DRY                     |
| [quality-gates.md](quality-gates.md)                 | Lint, typecheck, test, CI                  |
| [packaging.md](packaging.md)                         | Installers, ffmpeg, Azure Trusted Signing  |
