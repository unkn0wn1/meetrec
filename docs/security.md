...
Google Calendar and Microsoft Calendar connect use this flow. The upload consent is not in the app yet. It is separate from the xAI device-code client. Do not reuse that client id.
