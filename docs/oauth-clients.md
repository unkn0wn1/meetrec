...
Google Calendar and Microsoft Calendar connect are in Settings. Register each desktop client before you try it. Drive and OneDrive upload are not in the app yet.
