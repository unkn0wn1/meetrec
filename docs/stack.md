...
| Calendar          | Google Calendar readonly and Microsoft Graph. PKCE + loopback. Not in the app yet.          |
...
| Artifacts         | Local files, plus optional Google Drive and OneDrive app-folder upload. Not in the app yet. |
| Unit tests        | Vitest                                                                                      |
